...
if __name__ == "__main__":
    annotations_file = "/data/cmpe249-f20/WaymoCOCOMulti/trainvalall/annotations_train684step8allobject.json"
    image_dir= '/data/cmpe249-f20/WaymoCOCOMulti/trainvalall/'
