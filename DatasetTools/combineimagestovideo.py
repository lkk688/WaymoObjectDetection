...
def saveallcameratovideo(PATH, outputfile):
    ...
    imagefiles_pattern=glob.glob(os.path.join(PATH, '*.jpg'))
    print(f'Total image files: {len(imagefiles_pattern)}')
    for fileidx in range(100): #range(framenum+1):
...
if __name__ == "__main__":
    outputfile='/home/010796032/MyRepo/myoutputs/outputallcamera0526_detectron899k_val6_combine.mp4'
    PATH='/home/010796032/MyRepo/myoutputs/outputallcamera0526_detectron899k_val6/'
