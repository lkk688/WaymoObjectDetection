...
#             glob(join(self.load_dir, '*.tfrecord')))
    ...
    def convertcoroutine(self):
        ...
        future = asyncio.ensure_future(self.mycoroutinetask2())
    ...
    async def mycoroutinetask2(self):#https://github.com/jersobh/python-parallelism-examples/blob/master/async_concurrent_futures.py
