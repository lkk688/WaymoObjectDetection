...
class mmargs:
    Basemmdetection='/home/010796032/3DObject/mmdetection/'#'/Developer/3DObject/mmdetection/'
    config = Basemmdetection+'configs/faster_rcnn/myfaster_rcnn_x101_64x4d_fpn_1x_cocoHPC.py'
