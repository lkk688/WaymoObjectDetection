...
if __name__ == "__main__":
    ...
    nameprefix = "611tf2lite"#"609mmdet35valall"#"531mmdet27valall"#"0603dtrn2valall"
    objectfilepath = "/Developer/MyRepo/output/"+nameprefix+"_dicvalallcameraobjects"
    resultobjects=loadcreatedobjectfiles(objectfilepath)
    outputsubmissionfilepath="/Developer/MyRepo/output/"+nameprefix+"_dicvalallcamerasubmission.bin"
