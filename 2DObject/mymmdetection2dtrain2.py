...
Basemmdetection='/Developer/3DObject/mymmdetection/'
config = Basemmdetection+'configs/faster_rcnn/myfaster_rcnn_x101_64x4d_fpn_1x_coco.py' #'configs/faster_rcnn/faster_rcnn_r101_fpn_2x_coco.py'
# Setup a checkpoint file to load
checkpoint = Basemmdetection+'checkpoints/faster_rcnn_x101_64x4d_fpn_1x_coco_20200204-833ee192.pth' #'checkpoints/faster_rcnn_r101_fpn_2x_coco_bbox_mAP-0.398_20200504_210455-1d2dac9c.pth'
...
cfg.gpu_ids = range(1)
cfg.total_epochs = 4
cfg.runner.max_epochs = cfg.total_epochs # new added
