...
if __name__ == "__main__":
    ...
    cfg.MODEL.WEIGHTS = os.path.join('/home/010796032/MyRepo/Detectron2output/', "model_0399999.pth")
    cfg.SOLVER.IMS_PER_BATCH = 2 #4
    cfg.SOLVER.LR_SCHEDULER_NAME='WarmupCosineLR'
    cfg.SOLVER.BASE_LR = 0.00025  # pick a good LR
    cfg.SOLVER.MAX_ITER = 500000# 140000    # you may need to train longer for a practical dataset
