...
if __name__ == "__main__":
    ...
    base_dir="/Developer/3DObject"#"/data/cmpe249-f20/WaymoKittitMulti/dict_train0"
    ...
    MyDetectors.initialize_model()

    required_field = MyDetectors.DATA_FIELDS
    print(required_field)

    #result = MyDetectors.run_model(framedict[required_field[0]], framedict[required_field[1]])
    result = MyDetectors.run_model(**framedict)
    print(result)
